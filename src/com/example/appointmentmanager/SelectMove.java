...
public class SelectMove extends Activity implements OnClickListener {
	String SelectedDate = "";
	...
	public void onClick(View v) {
		...
		case R.id.move:
			...
			final Intent Create = new Intent(this, Move.class).putExtra(
			...
			new AlertDialog.Builder(this)
					...
					.setMessage(
							"Would you like to move event: " + TitleFor + "?")
