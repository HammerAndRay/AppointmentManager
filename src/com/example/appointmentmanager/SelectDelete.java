...
public class SelectDelete extends Activity implements OnClickListener {
	String SelectedDate = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View DeleteSome2 = findViewById(R.id.delete_some_button2);
		DeleteSome2.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.delete_some_button2:
			...
			new AlertDialog.Builder(this)
					...
					.setMessage(
							"Would you like to delete event: " + TitleFor + "?")
